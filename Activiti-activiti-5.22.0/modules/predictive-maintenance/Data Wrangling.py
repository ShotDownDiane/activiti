...
df_train_raw = pd.read_csv(workpath + '\\data\\PM_train.txt', sep = ' ', header=None)
df_train_raw.head()
...
#load test data
df_test_raw = pd.read_csv(workpath + '\\data\\PM_test.txt', sep = ' ', header=None)
df_test_raw.head()
...
df_truth = pd.read_csv(workpath + '\\data\\PM_truth.txt', sep = ' ', header=None)
df_truth.head()
...
df_train.dtypes
df_train.to_csv(workpath + '\\data\\train.csv', index=False)
...
df_test.to_csv(workpath + '\\data\\test.csv', index=False)

print('Data Wrangling finish')
